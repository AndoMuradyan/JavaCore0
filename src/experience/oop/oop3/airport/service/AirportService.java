package experience.oop.oop3.airport.service;
...
public class AirportService {
    ...
    public void printNameReleaseDate(Plane plane) {
...
//        return a.getName().length()>b.getName().length()?a:b;
    ...
    public void printNewestMilitary(Plane[] planes) {
        ...
        for (int i = indexOfMilitary; i < planes.length; i++) {
